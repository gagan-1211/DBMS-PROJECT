    ...
    <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand" href="index.php"><b>Smart Billing System</b></a>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 signup">
                        ...
                        <p>This platform serves as a consumer-centric solution, enabling seamless payment of electricity bills. It also facilitates efficient communication with service providers for addressing any grievances..</p>
                    </div>
                    <!-- /col-lg-6 -->
                    <div class="col-lg-6">
                        <h1>Join us</h1>
